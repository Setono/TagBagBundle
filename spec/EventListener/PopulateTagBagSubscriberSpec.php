...
class PopulateTagBagSubscriberSpec extends ObjectBehavior
{
    ...
    public function it_does_not_set_tag_bag_when_request_is_not_master_request(RequestEvent $event): void
    {
    ...
    public function it_does_not_set_tag_bag_when_session_does_not_have_session(RequestEvent $event, Request $request, SessionInterface $session): void
    {
    ...
    public function it_sets_tag_bag(TagBagInterface $tagBag, RequestEvent $event, Request $request, SessionInterface $session): void
    {
        $arr = ['section' => ['tag1']];
